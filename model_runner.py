...
def start_test(model_name, media_path, media_type, device_type, model_type, gui):
    t1 = threading.Thread(
        target=run_detection,
        args=(model_name, media_path, media_type, device_type, model_type, gui),
    )
    t1.start()


def run_detection(model_name, media_path, media_type, device_type, model_type, gui):
    ...
    match (model_name, media_type, model_type):
        ...
        case ("yolov11", "videos", "custom"):
            run_yolo_custom_videos(model_name, media_path, device, gui)
        case ("yolov11", "images", "custom"):
            run_yolo_custom_images(model_name, media_path, device, gui)
        ...
        case ("ssd", "videos", "custom"):
            run_ssd_custom_videos(media_path, device, gui)
        case ("ssd", "images", "custom"):
            run_ssd_custom_images(media_path, device, gui)
        ...
        case ("efficientdet", "videos", "custom"):
            run_efficientdet_custom_videos(media_path, device, gui)
        case ("efficientdet", "images", "custom"):
            run_efficientdet_custom_images(media_path, device, gui)
        ...
        case ("rt-detrv2", "videos", "custom"):
            run_rtdetrv2_custom_videos(media_path, device, gui)
        case ("rt-detrv2", "images", "custom"):
            run_rtdetrv2_custom_images(media_path, device, gui)
